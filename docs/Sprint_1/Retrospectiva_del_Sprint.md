...
- **Acierto de Infraestructura:** La decisión (tomada por Paul Paytan en el Sprint 0) de usar **Vite** en lugar de Webpack (Create-React-App) fue un éxito total. Los tiempos de compilación local (Hot Reloading) demoraban milisegundos, lo cual mantuvo a los desarrolladores del Frontend sin interrupciones. Mantendremos Vite como estándar sagrado.
...
- **Dolor en la Validación de Tipos:** El desarrollador Backend (Paul Paytan) escribía los esquemas de Mongoose con ciertas reglas, pero el desarrollador Frontend (Jack Rojas) no se enteraba y enviaba JSONs al revés, causando errores 500 y horas de depuración en llamadas post-man.
...
El *Scrum Master* (Paul Paytan) se compromete a supervisar que las medidas correctivas aquí descritas sean aplicadas en el Día 1 del **Sprint 2**. La reunión se da por concluida en 40 minutos exactos.
