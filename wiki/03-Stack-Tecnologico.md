...
El proyecto usa un stack **MERN Serverless (Firebase + React + Vite)**. Hemos evolucionado el stack MERN tradicional (MongoDB, Express, React, Node) utilizando la infraestructura de Google Firebase para garantizar máxima escalabilidad, zero DevOps overhead y un tier gratuito suficiente para el alcance académico del proyecto.

---

## Stack Completo

### Frontend (La "R" de MERN: React)
...
### Backend Serverless (La "E" y "N" de MERN: Express y Node)
...
### Base de Datos y Autenticación (La "M" de MERN: MongoDB -> Firestore)
